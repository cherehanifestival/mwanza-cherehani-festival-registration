...
export default function App() {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      /* =====================================================
         CONFIRMATION SMS
         Registration already succeeded even if SMS fails.
      ===================================================== */
          ...
          await supabase.functions.invoke(
            "send-sms",
            {
              body: {
                ...
                message:
                  `Asante ${form.jina_kamili.trim()}! ` +
                  `Usajili wako wa Mwanza Cherehani Festival 2026 ` +
                  `umepokelewa. Tutakutumia taarifa muhimu kuhusu tamasha.`,
              },
            }
          );
      ...
      <main className="page">
        <section className="success-card">
          ...
          <div className="notice">
            ...
            Usifanye malipo kwa namba yoyote ambayo haijatumwa rasmi
            na Kamati ya Mwanza Cherehani Festival 2026.
          </div>
